...
![image](https://github.com/user-attachments/assets/d901218c-71a9-4dc9-b243-eec0d60e1d3c)
...
def visualize_patterns_line(result, category):
    if result:
        ...
        # Iterate through each length group (k)
        for k, patterns_dict in result.items():
            for pattern, support_count in patterns_dict.items():
                patterns.append(f"{', '.join(pattern)}")  # Convert pattern to string for display
                support.append(support_count)
...
![image](https://github.com/user-attachments/assets/5d388637-d8ed-4162-8ac8-d314194ce94d)
